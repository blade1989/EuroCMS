...
<?php
  $myfile = fopen("article.php", "w") or die("Unable to open file!");




  $author = $_POST["author"];
  fwrite($myfile, "<span target=\"_blank\" href=\"/about\" title=\"author\" rel=\"author\" class=\"author\">$author</span>\n");



  $datetime = $_POST["datetime"];
  fwrite($myfile, "<time title=\"$datetime\" datetime=\"$datetime\">$datetime</time>\n");




  $header = $_POST["header"];
  fwrite($myfile, "<h1>$header</h1>\n");
