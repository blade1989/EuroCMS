...
$saveenabled = false; # set to false to disable saving ("demo mode")
...
if ($fmode=="edit") {
  ...
  <form method=\"post\" action=\"$my_name?file=$fname\">
    <div class=\"wmd-panel\">
      ...
      <textarea name=\"form-input-ta\" class=\"wmd-input\" id=\"wmd-input-second\" style=\" width:99%;\">$my_text</textarea>
